...
public class IonizedChroniteBlock extends Block {
	...
	public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
		...
		if (entity != null) {
			...
			sendPacket(ChroniteCore.MOD_ID, "particles", playeer, pos, world);}
	...
	public void sendPacket(String modid, String packetname, ServerPlayerEntity player, BlockPos pos, World world) {
